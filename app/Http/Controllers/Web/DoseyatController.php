...
class DoseyatController  extends Controller
{
    ...
    public function doseyat(Request $request)
    {
        $doseyats = Doseyat::with(['category', 'teacher', 'pos'])->get();
        
        // Get active categories that have doseyats
        ...
        return view('web.doseyat', compact('doseyats', 'categories', 'isApi'));
    }
