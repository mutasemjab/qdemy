...
@section('title', __('messages.add_new_bank_question'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('messages.add_new_bank_question') }}</h3>
                ...
                <form action="{{ route('bank-questions.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <!-- Parent Category -->
