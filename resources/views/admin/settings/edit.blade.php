                ...
                <div class="card-body">
                    <form action="{{ route('settings.update', $setting) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <small class="form-text text-muted">{{ __('messages.Leave empty to keep current logo') }}</small>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="text_under_logo_in_footer" class="required">{{ __('messages.Footer Text') }}</label>
                                    <textarea class="form-control @error('text_under_logo_in_footer') is-invalid @enderror" 
                                              id="text_under_logo_in_footer" name="text_under_logo_in_footer" 
                                              rows="4" required>{{ old('text_under_logo_in_footer', $setting->text_under_logo_in_footer) }}</textarea>
                                    @error('text_under_logo_in_footer')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">{{ __('messages.Text that appears under the logo in footer') }}</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('google_play_link') is-invalid @enderror" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('app_store_link') is-invalid @enderror" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('hawawi_link') is-invalid @enderror" 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="min_version_google_play">{{ __('messages.Min Version Google Play') }}</label>
                                    <input type="text" class="form-control @error('min_version_google_play') is-invalid @enderror" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="min_version_app_store">{{ __('messages.Min Version App Store') }}</label>
                                    <input type="text" class="form-control @error('min_version_app_store') is-invalid @enderror" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('min_version_hawawi') is-invalid @enderror" 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('number_of_students') is-invalid @enderror" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('number_of_teacher') is-invalid @enderror" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('number_of_course') is-invalid @enderror" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="number_of_viewing_hour">{{ __('messages.Number of Viewing Hours') }}</label>
                                    <input type="text" class="form-control @error('number_of_viewing_hour') is-invalid @enderror" 
