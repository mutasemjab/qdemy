                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($card->category)
                                                <span class="badge bg-info">{{ $card->category->name }}</span>
                                            @else
                                                <span class="badge bg-secondary">{{ __('messages.no_category') }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            @if($card->teacher)
                                                <span class="badge bg-info">{{ $card->teacher->name }}</span>
                                            @else
                                                <span class="badge bg-secondary">{{ __('messages.no_teacher') }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
