                    ...
                    <form action="{{ route('wallet_transactions.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                                ...
                                <option value="1" {{ old('type') == '1' ? 'selected' : '' }}>{{ __('messages.add_money') }}</option>
                                <option value="2" {{ old('type') == '2' ? 'selected' : '' }}>{{ __('messages.withdrawal') }}</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="note" id="note" class="form-control @error('note') is-invalid @enderror" 
                                      rows="3" placeholder="{{ __('messages.transaction_note_placeholder') }}">{{ old('note') }}</textarea>
                            @error('note')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
