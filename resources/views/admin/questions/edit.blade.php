                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('correct_feedback_en') is-invalid @enderror"
                                              ...
                                              rows="3"
                                              placeholder="e.g., Excellent! That's correct">{{ old('correct_feedback_en', $question->correct_feedback_en) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('incorrect_feedback_en') is-invalid @enderror"
                                              ...
                                              rows="3"
                                              placeholder="e.g., That's not quite right, try again">{{ old('incorrect_feedback_en', $question->incorrect_feedback_en) }}</textarea>
