...
@section('title', __('messages.edit_ministerial_question'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('messages.edit_ministerial_question') }}</h3>
                ...
                <form action="{{ route('ministerial-questions.update', $ministerialQuestion) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('display_name') is-invalid @enderror" 
                                           ...
                                           value="{{ old('display_name', $ministerialQuestion->display_name) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           ...
                                           value="{{ old('sort_order', $ministerialQuestion->sort_order ?? 0) }}" min="0">
                                    @error('sort_order')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="form-text text-muted">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check mt-2">
                                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" 
                                               value="1" {{ old('is_active', $ministerialQuestion->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="download_count" 
                                           value="{{ $ministerialQuestion->download_count ?? 0 }}" readonly>
                                    <small class="form-text text-muted">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="created_at" 
                                           value="{{ $ministerialQuestion->created_at->format('Y-m-d H:i:s') }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                        ...
                                        <div class="alert alert-success current-pdf">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <strong>{{ $ministerialQuestion->display_name ?: basename($ministerialQuestion->pdf) }}</strong>
                                                    @if($ministerialQuestion->pdf_size)
                                                        <span class="badge badge-info ml-2">{{ $ministerialQuestion->formatted_file_size }}</span>
                                                    @endif
                                                </div>
                                                <div>
                                                    <a target='_blank' href="{{ $ministerialQuestion->pdf_path }}" 
                                    ...
                                    @elseif($ministerialQuestion->pdf)
                                    <div class="mt-3">
                                        <div class="alert alert-warning">
                                            <i class="fas fa-exclamation-triangle mr-2"></i>
                                            {{ __('messages.current_file_missing') }}: {{ $ministerialQuestion->pdf }}
                                        </div>
                                    </div>
                                    @endif
                    ...
                    <div class="card-footer">
                        ...
                        @if($ministerialQuestion->pdf && $ministerialQuestion->pdfExists())
                            <a href="{{ route('ministerial-questions.download-pdf', $ministerialQuestion) }}" class="btn btn-info ml-2">
...
<script>
    $(document).ready(function() {
        ...
        function loadSubjects(categoryId) {
            ...
            $.ajax({
                url: '{{ route('ministerial-questions.subjects-by-category') }}',
                type: 'GET',
                ...
                success: function(data) {
                    ...
                    var selectedSubject = '{{ old('subject_id', $ministerialQuestion->subject_id) }}';
                    if (selectedSubject) {
