                ...
                <div class="card-body">
                    <form action="{{ route('teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name_of_lesson') is-invalid @enderror" 
                                           id="name_of_lesson" name="name_of_lesson" value="{{ old('name_of_lesson', $teacher->name_of_lesson) }}" required>
                            ...
                            <div class="col-md-6">
                                @if($teacher->user)
                                    <div class="form-group">
                                        ...
                                        <div class="alert alert-success">
                                            <i class="fas fa-user-check"></i> {{ __('messages.This teacher has a user account') }}
                                ...
                                @else
                                    <div class="alert alert-info">
                                        <i class="fas fa-info-circle"></i> {{ __('messages.This teacher does not have a user account') }}
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                              id="description_en" name="description_en" rows="3">{{ old('description_en', $teacher->description_en) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                              id="description_ar" name="description_ar" rows="3">{{ old('description_ar', $teacher->description_ar) }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('youtube') is-invalid @enderror" 
                                           id="youtube" name="youtube" value="{{ old('youtube', $teacher->youtube) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('whataspp') is-invalid @enderror" 
                                           id="whataspp" name="whataspp" value="{{ old('whataspp', $teacher->whataspp) }}" 
                        ...
                        <div id="user-account-section" style="display: none;">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="text-success mb-3">{{ __('messages.Update User Account Information') }}</h5>
                                    <p class="text-muted">{{ __('messages.Update the login account details for this teacher') }}</p>
                                </div>
