...
@section('title', __('messages.edit_boot_camp_question'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('messages.edit_boot_camp_question') }}</h3>
                ...
                <form action="{{ route('admin.boot-camp-questions.update', $bootCampQuestion) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('display_name') is-invalid @enderror" 
                                           ...
                                           value="{{ old('display_name', $bootCampQuestion->display_name) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           ...
                                           value="{{ old('sort_order', $bootCampQuestion->sort_order ?? 0) }}" min="0">
                                    @error('sort_order')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="form-text text-muted">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check mt-2">
                                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" 
                                               value="1" {{ old('is_active', $bootCampQuestion->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="download_count" 
                                           value="{{ $bootCampQuestion->download_count ?? 0 }}" readonly>
                                    <small class="form-text text-muted">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="created_at" 
                                           value="{{ $bootCampQuestion->created_at->format('Y-m-d H:i:s') }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                        ...
                                        <div class="alert alert-success current-pdf">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <strong>{{ $bootCampQuestion->display_name ?: basename($bootCampQuestion->pdf) }}</strong>
                                                    @if($bootCampQuestion->pdf_size)
                                                        <span class="badge badge-info ml-2">{{ $bootCampQuestion->formatted_file_size }}</span>
                                                    @endif
                                                </div>
                                                <div>
                                                    <a target='_blank' href="{{ $bootCampQuestion->pdf_path }}" 
                                    ...
                                    @elseif($bootCampQuestion->pdf)
                                    <div class="mt-3">
                                        <div class="alert alert-warning">
                                            <i class="fas fa-exclamation-triangle mr-2"></i>
                                            {{ __('messages.current_file_missing') }}: {{ $bootCampQuestion->pdf }}
                                        </div>
                                    </div>
                                    @endif
                    ...
                    <div class="card-footer">
                        ...
                        @if($bootCampQuestion->pdf && $bootCampQuestion->pdfExists())
                            <a href="{{ route('admin.boot-camp-questions.download-pdf', $bootCampQuestion) }}" class="btn btn-info ml-2">
        ...
        function loadSubjects(categoryId) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var selectedSubject = '{{ old('subject_id', $bootCampQuestion->subject_id) }}';
                    if (selectedSubject) {
