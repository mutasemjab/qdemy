...
@section('title', __('messages.edit_special_qdemy'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4>{{ __('messages.edit_special_qdemy') }}</h4>
                ...
                <div class="card-body">
                    <form action="{{ route('special-qdemies.update', $specialQdemy) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title_en') is-invalid @enderror" 
                                           ...
                                           value="{{ old('title_en', $specialQdemy->title_en) }}" required>
                                    @error('title_en')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title_ar') is-invalid @enderror" 
                                           ...
                                           value="{{ old('title_ar', $specialQdemy->title_ar) }}" 
                                           dir="rtl" required>
                                    @error('title_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
