...
@section('title', __('messages.edit_exam_question'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="card-title">{{ __('messages.edit_exam_question') }}</h3>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('exams.exam_questions.show', [$exam, $question]) }}" class="btn btn-info">
