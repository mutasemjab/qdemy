    ...
    <div class="container">
        ...
        <nav class="nav" id="navMenu">
            <ul>
                ...
                <li data-aos="fade">
                    <a class="{{ request()->routeIs('sale-point*') ? 'active' : '' }}" href="{{ route('sale-point') }}">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (trigger) {
        ...
        function open() { menu.style.display = 'block'; place(); add(); }
        function close() { menu.style.display = 'none'; rem(); }
        function add() {
