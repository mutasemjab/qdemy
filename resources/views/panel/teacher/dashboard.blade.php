                                ...
                                <div class="enrollment-item">
                                    <div class="student-info">
                                        ...
                                        <div class="student-details">
                                            ...
                                            <small>{{ __('panel.enrolled_in') }}:
                                                {{ $enrollment->course->title_ar }}</small>
                                        </div>
                                    </div>
                                    <div class="enrollment-meta">
                                        <span
                                            class="enrollment-date">{{ $enrollment->created_at->diffForHumans() }}</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                            ...
                            <div class="course-students-section">
                                <div class="course-header">
                                    <div class="course-info">
                                        ...
                                        <span class="students-count">{{ $course->students_count }}
                                        ...
                                        @foreach ($course->students as $student)
                                            <div class="student-card">
                                                ...
                                                <div class="student-info">
                                                    <h5>{{ $student->name }}</h5>
                                                    <p>{{ $student->email }}</p>
                                                    <small>{{ __('panel.joined') }}:
                                                        {{ $student->pivot->created_at ? $student->pivot->created_at->format('Y-m-d') : __('panel.unknown') }}</small>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
