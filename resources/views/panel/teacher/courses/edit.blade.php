            ...
            <form method="POST" action="{{ route('teacher.courses.update', $course) }}" enctype="multipart/form-data" class="course-form" id="courseForm">
                ...
                <div class="form-group">
                    <label for="is_sequential" class="checkbox-label">
                        ...
                        <input type="checkbox" id="is_sequential" name="is_sequential" value="1" {{ old('is_sequential', $course->is_sequential) ? 'checked' : '' }}>
...
.ud-user h3{font-size:24pxpx;margin:0 0 2px 0}
