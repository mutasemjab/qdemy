...
.course-name{margin:0;color:#6b7280;font-size:22px}
...
.form-section h3{margin:0 0 14px 0;color:#0f172a;font-size:24px;font-weight:900;border-bottom:1px solid #eef0f3;padding-bottom:10px}

.form-row{display:grid;grid-template-columns:1fr 1fr;gap:16px}
.form-group{display:flex;flex-direction:column;gap:8px}
.form-group label{font-weight:800;color:#0f172a}
.form-group input,.form-group select{width:100%;padding:12px 14px;border:1px solid #e5e7eb;border-radius:12px;font-size:22px;transition:box-shadow .16s,border-color .16s;background:#fff}
.form-group input:focus,.form-group select:focus{outline:none;border-color:#0055D2;box-shadow:0 0 0 4px rgba(0,85,210,.12)}
.form-text{color:#6b7280;font-size:20px;margin-top:-2px}
