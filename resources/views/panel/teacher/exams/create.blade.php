...
@section('styles')
    <style>
        ...
        .form-select:focus {
            border-color: #0055D2;
            box-shadow: 0 0 0 3px rgba(0, 85, 210, .12);
        }
    </style>
@endsection
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="text-dark fw-bold">{{ __('panel.create_exam') }}</h2>
                <p class="text-muted">{{ __('panel.create_new_exam_desc') }}</p>
            </div>
        ...
        <form action="{{ route('teacher.exams.store') }}" method="POST" id="examForm">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="title_en" class="form-control @error('title_en') is-invalid @enderror"
                            value="{{ old('title_en') }}" placeholder="{{ __('panel.enter_exam_title_en') }}">
                        @error('title_en')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="title_ar" class="form-control @error('title_ar') is-invalid @enderror"
                            value="{{ old('title_ar') }}" placeholder="{{ __('panel.enter_exam_title_ar') }}">
                        @error('title_ar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="description_en" class="form-control @error('description_en') is-invalid @enderror" rows="3"
                            placeholder="{{ __('panel.enter_description_en') }}">{{ old('description_en') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="description_ar" class="form-control @error('description_ar') is-invalid @enderror" rows="3"
                            placeholder="{{ __('panel.enter_description_ar') }}">{{ old('description_ar') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="attempts_allowed"
                            ...
                            value="{{ old('attempts_allowed', 1) }}" min="1" max="10">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="passing_grade"
                                ...
                                value="{{ old('passing_grade', 60) }}" min="0" max="100" step="0.01">
            ...
            <!-- Display Options -->
            <!-- Display Options Section - Replace your current one with this -->
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="shuffle_questions"
                                id="shuffle_questions" value="1" {{ old('shuffle_questions') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="shuffle_options" id="shuffle_options"
                                value="1" {{ old('shuffle_options') ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>{{ __('panel.create_exam') }}
                </button>
            </div>
        </form>
    </div>
            ...
            $(document).ready(function() {
                ...
                $('#subject_id').on('change', function() {
                    ...
                    if (subjectId) {
                        ...
                        const coursesUrl = '{{ route('teacher.exams.subjects.courses', '') }}/' +
                        subjectId;
                        $.get(coursesUrl)
                            .done(function(courses) {
                                ...
                                courses.forEach(course => {
                                    const title = '{{ app()->getLocale() }}' === 'ar' ? course
                                        .title_ar : course.title_en;
                                    courseSelect.append(
                                        `<option value="${course.id}">${title}</option>`);
                                });
                            })
                            .fail(function() {
                ...
                $('#course_id').on('change', function() {
                    ...
                    if (courseId) {
                        const sectionsUrl = '{{ route('teacher.exams.courses.sections', '') }}/' +
                        courseId;
                        $.get(sectionsUrl)
                ...
                // Form validation - REMOVED CHECKBOX CONVERSION
                $('#examForm').on('submit', function(e) {
                    let isValid = true;

                    // Check required fields
                    const requiredFields = ['title_en', 'title_ar', 'subject_id', 'attempts_allowed',
                        'passing_grade'
                    ];
