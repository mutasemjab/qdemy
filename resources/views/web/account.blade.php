  ...
  <div class="ud-content">
    ...
    <div class="ud-panel" id="inbox">
      ...
      <div class="ud-inbox">
        ...
        <div class="ud-title">الدورات</div>
        <div class="ud-courses">
            @for($i=0;$i<4;$i++)
            <a href="#" class="ud-course">
                <div class="ud-course-meta">
                <h3>اللغة العربية <br><span class="ud-course-meta-sub">الفصل الأول</span></h3>
                <div class="ud-course-teacher">
                    <img data-src="{{ asset('assets_front/images/teacher-mini.png') }}"><span>د. محمد خالد</span>
                </div>
                </div>
                <div class="ud-course-date">
                <small>1 - 28 July 2025</small>
                </div>
            </a>
            @endfor
        </div>
    ...
    <div class="ud-panel" id="schedule">
      <div class="ud-title">الجدول الزمني</div>
      <div class="ud-bars">
    ...
    <div class="ud-panel" id="results">
      <div class="ud-title">نتائج اختباراتي</div>
      <div class="ud-results">
        @for($i=0;$i<4;$i++)
          <a href="#" class="ud-res">
            <b>اختبار اللغة العربية</b>
            <span class="ud-res-score">80/100</span>
          </a>
        @endfor
      </div>
    </div>
