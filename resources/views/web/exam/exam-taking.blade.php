...
<div class="exam-taking-section" style="display: block;">
    ...
    <div class="exam-navigation">
        <div class="nav-buttons">
            <button type="button" class="btn-nav btn-prev" onclick="goToPreviousQuestion()" id="prevBtn" style="display: none;">
            ...
            <button type="button" class="btn-nav btn-submit" onclick="showSubmitConfirmation()" id="submitBtn" style="display: none;">
...
const examData = {
    ...
    saveAnswerUrl: "{{ route($apiRoutePrefix . 'save.answer.ajax', ['exam' => $exam->id]) . $queryParams }}",
...
function renderMultipleChoice(question, savedAnswer) {
    ...
    if (!question.options || question.options.length === 0) {
        html += '<p style="color: #999; text-align: center; padding: 20px;">{{ __("front.no_options_available") }}</p>';
    } else {
        question.options.forEach((option, index) => {
            ...
            const isChecked = Array.isArray(selectedOptions) && selectedOptions.some(id => String(id) === optionIdStr);
...
function renderTrueFalse(question, savedAnswer) {
    ...
    if (selectedAnswer !== null && selectedAnswer !== undefined) {
        if (selectedAnswer === true || selectedAnswer === 'true' || selectedAnswer === 1 || selectedAnswer === '1') {
            isTrue = true;
        } else if (selectedAnswer === false || selectedAnswer === 'false' || selectedAnswer === 0 || selectedAnswer === '0') {
            isFalse = true;
        }
    }
