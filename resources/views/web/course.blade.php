    ...
    <div class="crs2-main">
        <div class="crs2-main-inner">
            <div class="crs2-main-top">
                ...
                <div class="crs2-side-card">
                    <div class="crs2-side-cover">
                        ...
                        <div class="playable" data-video="{{ $freeContents->video_url }}"
                            ...
                            <img data-src="{{ $course->photo_url ?? asset('assets_front/images/ourse-cover-2.webp') }}" alt="{{ $course->title }}">
                            <span class="play-overlay"><i class="fas fa-play"></i></span>
                        </div>
                        @else
                        <img src="{{ $course->photo_url ?? asset('assets_front/images/ourse-cover-2.webp') }}" alt="{{ $course->title }}">
                        @endif
                    </div>
                    ...
                    <div class="crs2-side-body">
                        ...
                        @if($is_enrolled)
                            ...
                            <div class="crs2-progress-info">
                                <div class="crs2-progress-bar-container">
                                    ...
                                    <span class="crs2-progress-text">{{ round($course_progress) }}% {{ translate_lang('completed') }}</span>
                                </div>
                        ...
                        @else
                            <button id='buy_now' data-course-id="{{ $course->id }}" class="enroll-btn crs2-side-btn-primary">
                        ...
                        <div class="crs2-teacher-info">
                            ...
                            <div>
                                ...
                                <p>{{ translate_lang('video_all_count') }}: {{ $contents?->where('content_type','video')?->count() }}</p>
                            </div>
                        </div>
            ...
            <div class="crs2-card-activation">
                ...
                <input class="crs2-card-input" type="text" placeholder="{{ translate_lang('enter_card_here') }}">
            ...
            <!-- Course Content -->
            @if($is_enrolled && $user)
            <div class="crs2-enrolled-message">
                <h3>{{ translate_lang('go_to_app_to_watch_course') }}</h3>
            </div>
                            ...
                            @if($sectionContents && $sectionContents->count())
                                @foreach($sectionContents as $content)
                                    ...
                                    @if($content->video_url)
                                        @php
                                            $isContentLocked = isset($lockedContents[$content->id]) && $lockedContents[$content->id]['is_locked'];
                                        @endphp
                                            ...
                                            <div class="crs2-resource crs2-resource--locked">
                                                <div class="crs2-resource-main">
                                                    ...
                                                    <div class="crs2-resource-content">
                                                        ...
                                                        <span class="crs2-resource-locked-message">
                                                            {{ translate_lang('complete_lesson_first') }}: {{ $lockedContents[$content->id]['previous_content_title'] }}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if($content->file_path)
                                        ...
                                        <div class="crs2-resource crs2-resource--file">
                                            ...
                                            <div class="crs2-resource-actions">
                                                <a href="{{ $content->file_path }}" target="_blank" class="crs2-pill-btn crs2-pill-btn--blue">
                                ...
                                @if($is_enrolled && $sectionsExams && $sectionsExams->count())
                                    <div class="crs2-subgroup">
                                        <button type="button" class="crs2-sub-header">
                                            <span class="crs2-sub-title">{{ translate_lang('section_quiz') }}</span>
                                        ...
                                        <div class="crs2-sub-body">
                                            ...
                                            <div class="crs2-resource crs2-resource--exam">
                                                <div class="crs2-resource-main">
                                                    ...
                                                    <span class="crs2-resource-title">{{ $sectionsExam->title }}</span>
                                                </div>
                                                <div class="crs2-resource-actions">
                                                    <div class="crs2-resource-meta">
                                                        <span class="crs2-meta-chip">
                                                            {{ translate_lang('attempts') }}: {{ $sectionsExam->user_attempts()->count() }}
                                                        </span>
                                                        @if($sectionsExam->result_attempt())
                                                        <span class="crs2-meta-chip {{ $sectionsExam->result_attempt()->is_passed ? 'passed' : 'failed' }}">
                                                            <i class="fa fa-{{ $sectionsExam->result_attempt()->is_passed ? 'check' : 'times' }}"></i>
                                    ...
                                    <div class="crs2-sub-body">
                                        ...
                                        @if($subSectionContents && $subSectionContents->count())
                                            @foreach($subSectionContents as $subContent)
                                                @php
                                                    $subProgressPercent = $subContent->video_duration > 0 
                                                        ? min(100, ($subContent->watched_time / $subContent->video_duration) * 100) 
                                                        : 0;
                                                @endphp

                                                {{-- Video Content --}}
                                                @if($subContent->video_url)
                                                    @if($subContent->is_free === 1 || $is_enrolled)
                                                    <div class="crs2-resource crs2-resource--video">
                                                        <div class="crs2-resource-main lesson-video" 
                                                             data-video="{{ $subContent->video_url }}"
                                                             data-is-completed="{{ $subContent->is_completed }}" 
                                                             data-content-id="{{ $subContent->id }}" 
                                                             data-watched-time="{{ $subContent->watched_time }}" 
                                                            ...
                                                            @if($subContent->is_completed)
                                                                <span class="completion-badge">✓</span>
                                                            @elseif($subContent->watched_time > 0)
                                                        ...
                                                        @if($subContent->content_type === 'video' && ($subContent->is_free === 1 || $is_enrolled))
                                                        <div class="crs2-video-progress-bar">
                                                ...
                                                @if($subContent->file_path)
                                                    ...
                                                    <div class="crs2-resource crs2-resource--file">
                                                        ...
                                                        <div class="crs2-resource-actions">
                                                            <a href="{{ $subContent->file_path }}" target="_blank" class="crs2-pill-btn crs2-pill-btn--blue">
                                                                {{ translate_lang('download') }}
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        @if($is_enrolled && $subSectionsExams && $subSectionsExams->count())
                                            ...
                                            <div class="crs2-resource crs2-resource--exam">
                                                <div class="crs2-resource-main">
                                                    ...
                                                    <span class="crs2-resource-title">{{ $subExam->title }}</span>
                                                </div>
                                                <div class="crs2-resource-actions">
                                                    <div class="crs2-resource-meta">
                                                        <span class="crs2-meta-chip">
                                                            {{ translate_lang('attempts') }}: {{ $subExam->user_attempts()->count() }}
                                                        </span>
                                                        @if($subExam->result_attempt())
                                                        <span class="crs2-meta-chip {{ $subExam->result_attempt()->is_passed ? 'passed' : 'failed' }}">
                                                            <i class="fa fa-{{ $subExam->result_attempt()->is_passed ? 'check' : 'times' }}"></i>
                            ...
                            @foreach($unassignedContents as $_content)
                                ...
                                @if($_content->file_path)
                                    ...
                                    <div class="crs2-resource crs2-resource--file">
                                        ...
                                        <div class="crs2-resource-actions">
                                            <a href="{{ $_content->file_path }}" target="_blank" class="crs2-pill-btn crs2-pill-btn--blue">
                                                {{ translate_lang('download') }}
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="crs2-section-body">
                            ...
                            <div class="crs2-resource crs2-resource--exam">
                                ...
                                <div class="crs2-resource-actions">
                                    <div class="crs2-resource-meta">
                                        <span class="crs2-meta-chip">
                                            {{ translate_lang('trying_times') }}: {{ $exam->user_attempts()->count() }}
                                        </span>
                                        @if($exam->result_attempt())
                                        <span class="crs2-meta-chip {{ $exam->result_attempt()->is_passed ? 'passed' : 'failed' }}">
                                            <i class="fa fa-{{ $exam->result_attempt()->is_passed ? 'check' : 'times' }}"></i>
                                            {{ translate_lang('best_results') }}: {{ $exam->result_attempt()->percentage }}%
                                        </span>
                                        @endif
                                    </div>
            ...
            activateButton.addEventListener('click', function(e) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        alert('{{ translate_lang('activation_error') }}: ' + (data.message || 'Unknown error'));
                    }
                })
                .catch(error => {
            ...
            button.addEventListener('click', function(e) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        alert('{{ translate_lang('error_adding_course') }}: ' + (data.message || 'Unknown error'));
                    }
                })
                .catch(error => {
