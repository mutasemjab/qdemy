        ...
        <div class="t-hero">
            ...
            <div class="t-hero__info">
                ...
                <div class="t-socials">
                    ...
                    @endif
                    @if ($teacher->whataspp)
                        <a href="https://wa.me/{{ $teacher->whataspp }}" target="_blank" aria-label="WhatsApp">
...
@push('styles')
    <style>
        ...
        .t-socials a {
            ...
            background-image: linear-gradient(#1d72e8, #0054d2);
            box-shadow: 0 6px 20px rgba(1, 173, 94, .2)
        }
