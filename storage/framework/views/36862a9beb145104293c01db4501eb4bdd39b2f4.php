                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($card->category): ?>
                                                <span class="badge bg-info"><?php echo e($card->category->name); ?></span>
                                            <?php else: ?>
                                                <span class="badge bg-secondary"><?php echo e(__('messages.no_category')); ?></span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($card->teacher): ?>
                                                <span class="badge bg-info"><?php echo e($card->teacher->name); ?></span>
                                            <?php else: ?>
                                                <span class="badge bg-secondary"><?php echo e(__('messages.no_teacher')); ?></span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/admin/cards/show.blade.php ENDPATH**/ ?>