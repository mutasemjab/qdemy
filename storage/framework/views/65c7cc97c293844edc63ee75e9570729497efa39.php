...
<?php $__env->startSection('title', __('messages.add_new_ministerial_question')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('messages.add_new_ministerial_question')); ?></h3>
                    <div class="card-tools">
                        <a href="<?php echo e(route('ministerial-questions.index')); ?>" class="btn btn-secondary">
                ...
                <form action="<?php echo e(route('ministerial-questions.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <!-- Parent Category -->
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('ministerial-questions.index')); ?>" class="btn btn-secondary ml-2">
    ...
    $(document).ready(function() {
        ...
        $('#parent_category').change(function() {
            ...
            if (parentId) {
                ...
                $.ajax({
                    url: '<?php echo e(route('ministerial-questions.get-children', ':id')); ?>'.replace(':id', parentId),
                    type: 'GET',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\qdemy\resources\views/admin/ministerial_questions/create.blade.php ENDPATH**/ ?>