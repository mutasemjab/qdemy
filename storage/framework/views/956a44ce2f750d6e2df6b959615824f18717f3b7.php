<?php $__env->startSection('title', __('messages.Edit Category') . ' - ' . $category->name_ar); ?>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0"><?php echo e(__('messages.Edit Category')); ?></h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('categories.index')); ?>"><?php echo e(__('messages.Categories')); ?></a></li>
                            <li class="breadcrumb-item"><a href="<?php echo e(route('categories.show', $category)); ?>"><?php echo e($category->name_ar); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo e(__('messages.Edit')); ?></li>
                        </ol>
                    </nav>
                </div>
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('categories.show', $category)); ?>" class="btn btn-outline-info">
...
unset($__errorArgs, $__bag); ?>"
                                       id="name_ar" name="name_ar" value="<?php echo e(old('name_ar', $category->name_ar)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                       id="name_en" name="name_en" value="<?php echo e(old('name_en', $category->name_en)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- Parent Category -->
                            <div class="col-md-6">
                                <label for="category_id" class="form-label"><?php echo e(__('messages.Parent Category')); ?></label>
...
unset($__errorArgs, $__bag); ?>" onchange='toggleCategoryType()'
                                        id="category_id" name="parent_id">
                                    <option value=""><?php echo e(__('messages.Root Category')); ?></option>
                                    <?php $__currentLoopData = $parentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($parent['category']->id); ?>" <?php if($parent['category']->type == 'lesson'): ?> disabled style='background:lightgray;' <?php endif; ?>
                                                <?php echo e((old('parent_id', $category->parent_id) == $parent['category']->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                <?php if($category->children()->count() > 0): ?>
                                    <div class="form-text text-warning">
                                        ...
                                        <?php echo e(__('messages.This category has subcategories. Changing parent may affect hierarchy.')); ?>
                                ...
                                <select onchange='toggleCategoryType()' class="form-control <?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                <?php if($category->children()->count() > 0): ?>
                                    <div class="form-text text-warning">
                                        <i class="fas fa-exclamation-triangle"></i>
                                        <?php echo e(__('messages.Changing type may affect child categories and related data.')); ?>
                            ...
                            <div class="row px-3" id="optional_form_fields_div">
                                <div class="col-md-6">
                                    <label for="is_optional" class="form-label required"><?php echo e(__('messages.is_optional')); ?></label>
                                    <select class="form-control <?php $__errorArgs = ['is_optional'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="is_optional" name="is_optional">
                                        <option value="1" <?php echo e(old('is_optional', $category->is_optional) === 1 ? 'selected' : ''); ?>>
                                            <?php echo e(__('messages.optional')); ?>

                                        </option>
                                        <option value="0" <?php echo e(old('is_optional', $category->is_optional) === 0 ? 'selected' : ''); ?>>
                                            <?php echo e(__('messages.non_optional')); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <label for="is_ministry" class="form-label required"><?php echo e(__('messages.is_ministry')); ?></label>
                                    <select class="form-control <?php $__errorArgs = ['is_ministry'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="is_ministry" name="is_ministry">
                                        <option value="1" <?php echo e(old('is_ministry', $category->is_ministry) === 1 ? 'selected' : ''); ?>>
                                            <?php echo e(__('messages.Ministry Subject')); ?>

                                        </option>
                                        <option value="0" <?php echo e(old('is_ministry', $category->is_ministry) === 0 ? 'selected' : ''); ?>>
                                            <?php echo e(__('messages.School Subject')); ?>

                                        </option>
                                    </select>
                                    <?php $__errorArgs = ['is_ministry'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <label for="field_type" class="form-label required"><?php echo e(__('messages.field_type')); ?></label>
                                    <select class="form-control <?php $__errorArgs = ['field_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="field_type" name="field_type">
                                        <option value=""></option>
                                        <?php $__currentLoopData = FIELD_TYPE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(old('field_type', $category->field_type) == $value ? 'selected' : ''); ?>>
                                    ...
                                    <div class="form-text">
                                        <?php echo e(__('messages.Name of the group to which the material belongs')); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <label for="optional_form_field_type" class="form-label required"><?php echo e(__('messages.optional_form_field_type')); ?></label>
                                    <select class="form-control <?php $__errorArgs = ['optional_form_field_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  name="optional_form_field_type">
                                        <option value=""></option>
                                        <?php $__currentLoopData = OPTIONAL_FROM_FIELD_TYPE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(old('optional_form_field_type', $category->optional_form_field_type) == $value ? 'selected' : ''); ?>>
                                            <?php echo e(__('messages.'.$value)); ?>
                                    ...
                                    <div class="form-text">
                                        <?php echo e(__('messages.messages.Name of the group to which the subject will fill with')); ?>

                                    </div>
                                    <?php $__errorArgs = ['optional_form_field_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       id="color" name="color" value="<?php echo e(old('color', $category->color)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                          id="description_ar" name="description_ar" rows="3"><?php echo e(old('description_ar', $category->description_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          id="description_en" name="description_en" rows="3"><?php echo e(old('description_en', $category->description_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1"
                                           id="is_active" name="is_active" <?php echo e(old('is_active', $category->is_active) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-12">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="card-title"><?php echo e(__('messages.Category Information')); ?></h6>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <strong><?php echo e(__('messages.ID')); ?>:</strong> <?php echo e($category->id); ?>

                                            </div>
                                            <div class="col-md-4">
                                                <strong><?php echo e(__('messages.Level')); ?>:</strong> <?php echo e($category->depth); ?>

                                            </div>
                                            <div class="col-md-4">
                                                <strong><?php echo e(__('messages.Children Count')); ?>:</strong> <?php echo e($category->children()->count()); ?>

                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-6">
                                                <strong><?php echo e(__('messages.Created')); ?>:</strong> <?php echo e($category->created_at->format('Y-m-d H:i')); ?>

                                            </div>
                                            <div class="col-md-6">
                                                <strong><?php echo e(__('messages.Updated')); ?>:</strong> <?php echo e($category->updated_at->format('Y-m-d H:i')); ?>

                                            </div>
                                        </div>
                                        <?php if($category->breadcrumb): ?>
                                            <div class="row mt-2">
                                                <div class="col-12">
                                                    <strong><?php echo e(__('messages.Path')); ?>:</strong> <?php echo e($category->breadcrumb); ?>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="<?php echo e(route('categories.show', $category)); ?>" class="btn btn-secondary">
                                <?php echo e(__('messages.Cancel')); ?>

                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i><?php echo e(__('messages.Update Category')); ?>
...
<script>
    let is_editable = <?php echo e($is_editable); ?>;
    let tawjihi_optional_fields_ctg_ids = <?php echo json_encode($tawjihi_optional_fields_ctg_ids, 15, 512) ?>;
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('categories.show', $category)); ?>" class="btn btn-outline-info">
                        <i class="fas fa-eye me-2"></i><?php echo e(__('View')); ?>
...
unset($__errorArgs, $__bag); ?>
                                <?php if($category->children()->count() > 0): ?>
                                    <div class="form-text text-warning">
                                        <i class="fas fa-exclamation-triangle"></i>
                                        <?php echo e(__('This category has subcategories. Changing parent may affect hierarchy.')); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="card-title"><?php echo e(__('Category Information')); ?></h6>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <strong><?php echo e(__('ID')); ?>:</strong> <?php echo e($category->id); ?>

                                            </div>
                                            <div class="col-md-4">
                                                <strong><?php echo e(__('Level')); ?>:</strong> <?php echo e($category->depth); ?>

                                            </div>
                                            <div class="col-md-4">
                                                <strong><?php echo e(__('Children Count')); ?>:</strong> <?php echo e($category->children()->count()); ?>

                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-6">
                                                <strong><?php echo e(__('Created')); ?>:</strong> <?php echo e($category->created_at->format('Y-m-d H:i')); ?>

                                            </div>
                                            <div class="col-md-6">
                                                <strong><?php echo e(__('Updated')); ?>:</strong> <?php echo e($category->updated_at->format('Y-m-d H:i')); ?>
                                        ...
                                        <?php if($category->breadcrumb): ?>
                                            <div class="row mt-2">
                                                <div class="col-12">
                                                    <strong><?php echo e(__('Path')); ?>:</strong> <?php echo e($category->breadcrumb); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>