            ...
            <form method="GET" action="<?php echo e(route('packages.index')); ?>" class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control" id="type" name="type">
                        ...
                        <option value="lesson" <?php echo e(request('type') === 'lesson' ? 'selected' : ''); ?>>
                                    ...
                                    <td>
                                        <?php if($package->categories->count() > 0): ?>
                                            <span class="badge badge-secondary">
                                                <?php echo e($package->categories->count()); ?> <?php echo e(__('messages.Categories')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\qdemy\resources\views/admin/packages/index.blade.php ENDPATH**/ ?>