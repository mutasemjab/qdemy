<div class="category-item border-bottom" data-category-id="<?php echo e($category->id); ?>">
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="btn-group" role="group">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category-add')): ?>
                        <a href="<?php echo e(route('categories.create', ['parent_id' => $category->id])); ?>" 
                           class="btn btn-sm btn-outline-success" 
                           title="<?php echo e(__('messages.Add Child')); ?>">
    ...
    <?php endif; ?>
</div><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/admin/categories/partials/tree-item.blade.php ENDPATH**/ ?>