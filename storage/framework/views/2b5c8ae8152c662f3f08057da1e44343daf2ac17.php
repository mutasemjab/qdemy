            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item <?php echo e(request()->routeIs(['banners.*', 'blogs.*', 'admin.community.posts.*']) ? 'menu-open' : ''); ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php endif; ?>
                         <?php if($user->can('page-table') || $user->can('page-add') || $user->can('page-edit') || $user->can('page-delete')): ?>
                        <li class="nav-item">
...
<?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>