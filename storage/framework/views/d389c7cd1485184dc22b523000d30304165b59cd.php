...
<section class="lesson-page">
    ...
    <div class="lesson-container">
        ...
        <div class="lesson-sidebar">
            <div class="lesson-card">
                ...
                <div class="lesson-card-info">
                    ...
                    <?php if($is_enrolled): ?>
                        <a href="javascript:void(0)" class="btn-buy"><?php echo e(translate_lang('enrolled')); ?></a>
                        <!-- Progress Display -->
                        <div class="progress-info">
                            <div class="progress-bar-container">
                                <div class="progress-bar" style="width: <?php echo e($course_progress); ?>%"></div>
                                <span class="progress-text"><?php echo e(round($course_progress)); ?>% <?php echo e(translate_lang('completed')); ?></span>
                            </div>
                            <div class="progress-stats">
                                <span><?php echo e(translate_lang('completed')); ?>: <?php echo e($completed_videos); ?></span>
                                <span><?php echo e(translate_lang('watching')); ?>: <?php echo e($watching_videos); ?></span>
                                <span><?php echo e(translate_lang('total_videos')); ?>: <?php echo e($total_videos); ?></span>
                            </div>
                        </div>
                    <?php elseif(is_array($user_courses) && in_array($course->id,$user_courses)): ?>
                      <a href="<?php echo e(route('checkout')); ?>"class="btn-buy"><?php echo e(translate_lang('buy_now')); ?></a>
                      <a href="<?php echo e(route('checkout')); ?>"class="btn-add"><?php echo e(translate_lang('go_to_checkout')); ?></a>
                    <?php else: ?>
                        <a id='buy_now' href="javascript:void(0)" data-course-id="<?php echo e($course->id); ?>" class="enroll-btn btn-buy"><?php echo e(translate_lang('buy_now')); ?></a>
                        <a href="javascript:void(0)" data-course-id="<?php echo e($course->id); ?>" class="enroll-btn btn-add"><?php echo e(translate_lang('add_to_cart')); ?></a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('contacts')); ?>" class="text-decoration-none"><p class="report"><?php echo e(translate_lang('report_this_course')); ?></p></a>
                </div>
            </div>
            ...
            <div class="lesson-teacher">
                ...
                <p><?php echo e(translate_lang('session_all_count')); ?> - <?php echo e($mainSections?->count()); ?>

                    <br> <?php echo e(translate_lang('video_all_count')); ?> - <?php echo e($contents?->where('content_type','video')?->count()); ?></p>
            </div>
            ...
            <div class="lesson-card-activation">
                ...
                <button data-course-id="<?php echo e($course->id); ?>" class="lesson-card-activation button"><?php echo e(translate_lang('activate_card')); ?></button>
            </div>
            <?php endif; ?>
        ...
        <div class="lesson-content">
            ...
            <h3 class="lesson-subtitle"><?php echo e(translate_lang('course_content')); ?></h3>
            ...
            <div class="accordion">
                        ...
                        <div class="accordion-body">
                                ...
                                <?php $__currentLoopData = $sectionContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="lesson-item" data-content-id="<?php echo e($content->id); ?>">
                                        <?php if($content->video_url): ?>
                                            ...
                                            <?php if(!$is_enrolled): ?> <span class='free'>free</span><?php endif; ?>
                                            <?php else: ?>
                                    ...
                                    <?php if($is_enrolled && $sectionsExams && $sectionsExams->count()): ?>
                                        <span><?php echo e(translate_lang('section Quiz')); ?></span>
                                        <?php $__currentLoopData = $sectionsExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionsExam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="lesson-item exam">
                                                <a class='text-decoration-none d-flex' target='_blank' href="<?php echo e(route('exam',['exam'=>$sectionsExam->id,'slug'=>$sectionsExam->slug])); ?>">
                                                <div class="lesson-info">
                                                    <h4> <i class="fa fa-question" style='color:rgba(0, 85, 210, 0.7);'></i> <?php echo e($sectionsExam->title); ?> </h4>
                                                    <div class="">
                                                        <br>
                                                        <i class="fa fa-check"></i> <?php echo e(translate_lang('عدد المحاولات')); ?> <?php echo e($sectionsExam->user_attempts()->count()); ?>
                            ...
                            <?php if($subSections && $subSections->count()): ?>
                                ...
                                <div class="accordion">
                                                ...
                                                <div class="lesson-item" data-content-id="<?php echo e($subSectioncontent->id); ?>">
                                                    <?php if($subSectioncontent->video_url): ?>
                                                        ...
                                                        <div class="lesson-video" data-video="<?php echo e($subSectioncontent->video_url); ?>"
                                                            ...
                                                            <?php elseif($subSectioncontent->watched_time > 0): ?>
                                                                <span class="progress-badge"><?php echo e(round($subContProgressPercent)); ?>%</span>
                                                            <?php endif; ?>
                                                        </div>
                                                        <?php if(!$is_enrolled): ?> <span class='free'>free</span><?php endif; ?>
                                                        <?php else: ?>
                                                    ...
                                                    <div class="lesson-info">
                                                        ...
                                                        <?php if($subSectioncontent->content_type === 'video' && ($subSectioncontent->is_free === 1 || $is_enrolled)): ?>
                                                            <div class="video-progress-bar">
                                                                <div class="progress-fill" style="width: <?php echo e($subContProgressPercent); ?>%"></div>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                    ...
                                    <!-- sub sections Quizes -->
                                    <?php $subSectionsExamss = $subSection->exams ?>
                                    <?php if($is_enrolled && $subSectionsExams && $subSectionsExams->count()): ?>
                                        ...
                                        <?php $__currentLoopData = $subSectionsExamss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSectionsExams): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="lesson-item exam">
                                                <a class='text-decoration-none d-flex' target='_blank' href="<?php echo e(route('exam',['exam'=>$subSectionsExams->id,'slug'=>$subSectionsExams->slug])); ?>">
                                                <div class="lesson-info">
                                                    <h4> <i class="fa fa-question" style='color:rgba(0, 85, 210, 0.7);'></i> <?php echo e($subSectionsExams->title); ?> </h4>
                                                    <div class="">
                                                        <br>
                                                        <i class="fa fa-check"></i> <?php echo e(translate_lang('عدد المحاولات')); ?> <?php echo e($subSectionsExams->user_attempts()->count()); ?>
                ...
                <div class="accordion-item">
                    <button class="accordion-header"><?php echo e(translate_lang('Unassigned Contents')); ?> </button>
                    <div class="accordion-body">
                            ...
                            <div class="lesson-item" data-content-id="<?php echo e($_content->id); ?>">
                                <?php if($_content->video_url): ?>
                                    ...
                                    <div class="lesson-video" data-video="<?php echo e($_content->video_url); ?>"
                                        ...
                                        <?php elseif($_content->watched_time > 0): ?>
                                            <span class="progress-badge"><?php echo e(round($unasgndCntProgressPercent)); ?>%</span>
                                        <?php endif; ?>
                                    </div>
                                    <?php if(!$is_enrolled): ?> <span class='free'>free</span><?php endif; ?>
                                    <?php else: ?>
                                ...
                                <div class="lesson-info">
                                    ...
                                    <?php if($_content->content_type === 'video' && ($_content->is_free === 1 || $is_enrolled)): ?>
                                        <div class="video-progress-bar">
                                            <div class="progress-fill" style="width: <?php echo e($unasgndCntProgressPercent); ?>%"></div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                ...
                <div class="accordion-item">
                    <button class="accordion-header"> <?php echo e(translate_lang('All course Quiez')); ?></button>
                    <div class="accordion-body">
                        <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="lesson-item exam">
                                <a class='text-decoration-none d-flex' target='_blank' href="<?php echo e(route('exam',['exam'=>$exam->id,'slug'=>$exam->slug])); ?>">
                                    <div class="lesson-info">
                                    <h4> <i class="fa fa-question" style='color:rgba(0, 85, 210, 0.7);'></i> <?php echo e($exam->title); ?> </h4>
                                    <div class="">
                                        <br>
                                        <i class="fa fa-check"></i> <?php echo e(translate_lang('trying times')); ?> <?php echo e($exam->user_attempts()->count()); ?>
                                        ...
                                        <?php if($exam->result_attempt()): ?>
                                            <?php echo e(translate_lang('best_results')); ?>
...
<div id="enrollment-modal" class="messages modal">
    <div class="modal-content">
        ...
        <h3><?php echo e(translate_lang('course_added')); ?></h3>
        <p><?php echo e(translate_lang('course_added_successfully')); ?></p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        activateButton.addEventListener('click', function(e) {
            ...
            if(!user){
                alert("<?php echo e(translate_lang('please login first .')); ?>");
                return 0;
            }else if (!cardNumber) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        enrollButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                // إظهار مؤشر تحميل (اختياري)
                this.innerHTML = '<?php echo e(translate_lang("loading")); ?>';
                this.disabled = true;
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        this.innerHTML = "<?php echo e(translate_lang('go_to_checkout')); ?>";
                        this.disabled = false;
                    }else {
...
<script>
    ...
    function updateProgressDisplay(progressData) {
        if (progressData) {
            ...
            if (progressText) {
                progressText.textContent = Math.round(progressData.course_progress) + '% ' + "<?php echo e(translate_lang('completed')); ?>";
            }

            if (progressStats) {
                progressStats.innerHTML = `
                    <span><?php echo e(translate_lang('completed')); ?>: ${progressData.completed_videos}</span>
                    <span><?php echo e(translate_lang('watching')); ?>: ${progressData.watching_videos}</span>
                    <span><?php echo e(translate_lang('total_videos')); ?>: ${progressData.total_videos}</span>
                `;
            }
        }
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/web/course.blade.php ENDPATH**/ ?>