...
<section class="tawjihi-page">
    <a href="<?php echo e(route('tawjihi-first-year',['slug'=>$tawjihiFirstYear?->slug])); ?>" class="tawjihi-card" style="background-image: url('<?php echo e(asset('images/tawjihi-2009.png')); ?>');">
        <div class="tawjihi-text">
            <h3><?php echo e(__('messages.tawjihi')); ?></h3>
    ...
    <a href="#" class="tawjihi-card" style="display:none;background-image: url('<?php echo e(asset('images/tawjihi-2008.png')); ?>');">
        <div class="tawjihi-text">
            <h3><?php echo e($tawjihiVocational?->localized_name); ?></h3>
        </div>
    </a>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/user/tawjihi.blade.php ENDPATH**/ ?>