...
<section class="gprograms-page">
    ...
    <a href="<?php echo e(route('international-programm',['programm'=>$programm->id,'slug'=>$programm->slug])); ?>" class="gprogram-card gprogram-card-american">
        ...
        <span><?php echo e($programm->localized_name); ?>cgg</span>
    </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\qdemy\resources\views/web/gprograms.blade.php ENDPATH**/ ?>