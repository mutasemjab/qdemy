        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('messages.add_subject')); ?></h3>
                ...
                <form action="<?php echo e(route('subjects.store')); ?>" method="POST" id="subjectForm">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <!-- Arabic Name -->
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($program->id); ?>"
                                                    ...
                                                    <?php echo e(old('programm_id') == $program->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6" id="gradeSection" style="display: none;">
                                <div class="form-group mb-3">
                                    <label for="grade_id" class="form-label">
                                        <?php echo e(__('messages.grade')); ?> <span class="text-danger grade-required" style="display: none;">*</span>
                                    </label>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="0" <?php echo e(old('is_optional_single', 0) == 0 ? 'selected' : ''); ?>>
                                                    <?php echo e(__('messages.no')); ?>

                                                </option>
                                                <option value="1" <?php echo e(old('is_optional_single') == 1 ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="1" <?php echo e(old('is_ministry_single', 1) == 1 ? 'selected' : ''); ?>>
                                                    <?php echo e(__('messages.yes')); ?>

                                                </option>
                                                <option value="0" <?php echo e(old('is_ministry_single') == 0 ? 'selected' : ''); ?>>
                                                    <?php echo e(__('messages.no')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <?php $__currentLoopData = $fieldTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fieldType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($fieldType->id); ?>"
                                                        <?php echo e(old('field_type_id') == $fieldType->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/admin/subjects/create.blade.php ENDPATH**/ ?>