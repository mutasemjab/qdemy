...
<?php $__env->startSection('title', __('messages.edit_question')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('messages.edit_question')); ?></h3>
                    <div class="card-tools">
                        ...
                        <a href="<?php echo e(route('questions.show', $question)); ?>" class="btn btn-info">
                ...
                <form action="<?php echo e(route('questions.update', $question)); ?>" method="POST" id="questionForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="title_en" 
                                           name="title_en" 
                                           value="<?php echo e(old('title_en', $question->title_en)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                           id="title_ar" 
                                           name="title_ar" 
                                           value="<?php echo e(old('title_ar', $question->title_ar)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="question_en" 
                                              rows="4" 
                                              placeholder="<?php echo e(__('messages.enter_question_text_en')); ?>"><?php echo e(old('question_en', $question->question_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              dir="rtl"><?php echo e(old('question_ar', $question->question_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($course->id); ?>" 
                                                    <?php echo e(old('course_id', $question->course_id) == $course->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="grade" 
                                           name="grade" 
                                           value="<?php echo e(old('grade', $question->grade)); ?>" 
                                           step="0.25" 
                                           min="0.25"
                                           placeholder="1.00">
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="explanation_en" 
                                              rows="3" 
                                              placeholder="<?php echo e(__('messages.optional_explanation_en')); ?>"><?php echo e(old('explanation_en', $question->explanation_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              dir="rtl"><?php echo e(old('explanation_ar', $question->explanation_ar)); ?></textarea>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="true_false_answer" 
                                           ...
                                           <?php echo e(old('true_false_answer', $correctAnswer) == '1' ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="true_false_answer" 
                                           ...
                                           <?php echo e(old('true_false_answer', $correctAnswer) == '0' ? 'checked' : ''); ?>>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> <?php echo e(__('messages.update_question')); ?>
...
<script>
let optionCount = 0;
const existingOptions = <?php echo json_encode($question->options->toArray(), 15, 512) ?>;
    ...
    return `
        <div class="option-item mb-3 p-3 border rounded" id="option-${count}">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h6 class="mb-0"><?php echo e(__('messages.option')); ?> ${String.fromCharCode(64 + count)}</h6>
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" name="options[${count-1}][option_en]" 
                           value="${optionEn}" placeholder="<?php echo e(__('messages.enter_option_en')); ?>" required>
                </div>
                <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" name="options[${count-1}][option_ar]" 
                           value="${optionAr}" placeholder="<?php echo e(__('messages.enter_option_ar')); ?>" dir="rtl" required>
                </div>
                <div class="col-md-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/admin/questions/edit.blade.php ENDPATH**/ ?>