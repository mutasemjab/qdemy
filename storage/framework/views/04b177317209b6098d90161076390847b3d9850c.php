<footer class="footer">
    <div class="footer-container">
        ...
        <div class="footer-logo-section">
            <img src="<?php echo e(asset('assets_front/images/logo-white.png')); ?>" alt="Qdemy Logo" class="footer-logo">
            <p class="footer-desc">
        ...
        <div class="footer-column">
            ...
            <div>
                <h4>Quick Links</h4>
                <ul>
                    <li><a href="<?php echo e(route('international-programms')); ?>">International Program</a></li>
...
<?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/layouts/footer.blade.php ENDPATH**/ ?>