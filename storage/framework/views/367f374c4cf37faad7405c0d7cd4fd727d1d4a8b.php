                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="subject_id" class="form-label">
                                        <?php echo e(__('messages.subject')); ?> <span class="text-danger">*</span>
                                    </label>
                                    <select class="form-select form-control <?php $__errorArgs = ['subject_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($subject->id); ?>"
                                                ...
                                                <?php echo e(app()->getLocale() === 'ar' ? $subject->name_ar : $subject->name_en); ?>

                                                <?php if($subject->grade): ?>
                                                    - <?php echo e(app()->getLocale() === 'ar' ? $subject->grade->name_ar : $subject->grade->name_en); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            disabled>
                                        <option value=""><?php echo e(__('messages.select_course_optional')); ?></option>
                                    </select>
                                    <small class="form-text text-muted"><?php echo e(__('messages.select_subject_first')); ?></small>
...
function loadSubjectCourses(subjectId) {
    ...
    courseSelect.innerHTML = '<option value=""><?php echo e(__('messages.select_course_optional')); ?></option>';
    ...
    fetch(`<?php echo e(route('admin.subjects.courses', ':subject')); ?>`.replace(':subject', subjectId), {
            method: 'GET',
            headers: {
...
function loadCourseSections(courseId) {
    ...
    fetch(`<?php echo e(route('admin.courses.sections', ':course')); ?>`.replace(':course', courseId), {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': csrfToken
