        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('messages.edit_course')); ?></h3>
...
unset($__errorArgs, $__bag); ?>"
                                           id="title_en"
                                           name="title_en"
                                           value="<?php echo e(old('title_en', $course->title_en)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                           id="title_ar"
                                           name="title_ar"
                                           value="<?php echo e(old('title_ar', $course->title_ar)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                              ...
                                              name="description_en"
                                              rows="4"
                                              placeholder="<?php echo e(__('messages.enter_description_en')); ?>"><?php echo e(old('description_en', $course->description_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                              ...
                                              dir="rtl"><?php echo e(old('description_ar', $course->description_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                               id="selling_price"
                                               name="selling_price"
                                               value="<?php echo e(old('selling_price', $course->selling_price)); ?>"
                                               step="0.01"
                                               min="0"
                                               placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($teacher->id); ?>"
                                                    <?php echo e(old('teacher_id', $course->teacher_id) == $teacher->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    <label for="photo" class="form-label">
                                        <?php echo e(__('messages.new_photo')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/admin/courses/edit.blade.php ENDPATH**/ ?>