...
<section class="examx-page">
    ...
    <div class="examx-filters">
        ...
        <form action='<?php echo e(route("exam.index")); ?>' method='get' id="filterForm">
            <div class="examx-row">
    ...
    <div class="examx-grid">
        ...
        <div class="examx-card">
            <div class="examx-content">
                ...
                <?php else: ?>
                <a href="<?php echo e(route('review.attempt',['exam'=>$exam->id,'attempt'=>$exam->last_submitted_attempt()->id])); ?>" class="examx-btn">
                    <?php echo e(translate_lang('last attempt')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\xampp-8.1.1\htdocs\qdemy-main\resources\views/web/exam/index.blade.php ENDPATH**/ ?>